...
def processing(df1,df2):
    ...
    df_merge=pd.merge(df2,df1,on='name').drop(['menu_y','mean_price_y'],axis=1)
    ...
    df_merge.loc[df_merge['naver_people_give_score']=='표기 안함','naver_people_give_score'] = 0
    df_merge =df_merge.astype({'naver_people_give_score':'int32'})

    df_merge['total_score'] = df_merge['naver_score']*df_merge['naver_people_give_score']\
                                +df_merge['kakao_score']*df_merge['kakao_people_give_score']

    df_merge['total_score'] = df_merge['total_score']/(df_merge['naver_people_give_score']+df_merge['kakao_people_give_score'])
...
road1= '/Users/seop/Documents/GitHub/Trend_Analysis_and_Recommendation_System_Project/Region'
road2='/Users/seop/Desktop/크롤링'
